...
int main(int, char **)
{
    ...
    // column
    // RM(5,0)  BV(5,1)  SL(5,2)
    // BL(7,0)  .......  SL(7,2)
    // .......  RM(8,1)  .......
    if (!test(".892.7.434261938757.38.4.9226.37195..7.62.31....54.267697432581.4.9857.68..7164.9",
              R"(
                .--------------.-----------.------------.
                | 15   8   9   | 2  56  7  | 16  4   3  |
                | 4    2   6   | 1  9   3  | 8   7   5  |
                | 7    15  3   | 8  56  4  | 16  9   2  |
                :--------------+-----------+------------:
                | 2    6   48  | 3  7   1  | 9   5   48 |
                | 59   7   458 | 6  2   89 | 3   1   48 |
                | 139  13  18  | 5  4   89 | 2   6   7  |
                :--------------+-----------+------------:
                | 6    9   7   | 4  3   2  | 5   8   1  |
                | 13   4   12  | 9  8   5  | 7   23  6  |
                | 8    35  25  | 7  1   6  | 4   23  9  |
                '--------------'-----------'------------'
              )",
              R"(
                .-------------.-----------.------------.
