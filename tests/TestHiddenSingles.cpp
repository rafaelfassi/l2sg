...
bool test(const std::string &puzzle, const std::string &board, solver::Technique expectedTechnique)
{
    ...
    solver::Logs logs;
    bool changed = solver::techniques::hiddenSingles(grid, &logs);
...
int main(int, char **)
{
    ...
    if (!test(".....14.2..1....9.98.452...1...49.3.794...165.3.51..4....17..24.1....6..8.23.....",
              R"(
                ...
                | 24   24    1    | 678   368   3678 | 3(=5)78  9    3678 |
    ...
    if (!test(".7.......96.78..414...69.5779......33..6.7..55.6.9.724.3745...924..38576....7.43.",
              R"(
                ...
                | 2    4       19    | 19    3    8     | 5    7    6  |
                | 168  1(=5)8  1589  | 129   7    126   | 4    3    28 |
                '--------------------'------------------'--------------'
              )",
              solver::Technique::HiddenSingles))
        return failed();
    ...
    if (!test("98.7..6....7.5..49.....9...3..9......9..8.2....8..5.97.1..4.9.....5...84....9....",
              R"(
                .-------------------------.-----------------------.----------------------.
                ...
                | 267     2367    236(=9) | 5       12367  12367  | 137    8       4     |
