...
int main(int, char **)
{
    ...
    if (!test(solver::HiddenMultiType::Pair,
              ...
              R"(
                .---------------------------------.-----------------.-------------.
                | (*47-23589)  (*47-12358)  12389 | 1589   6   1589 | 158  15  29 |
    ...
    if (!test(solver::HiddenMultiType::Pair,
              ...
              R"(
                ...
                | 1   2346  246  | 257    (*34-57)  57    | 35679  3679  8    |
    ...
    if (!test(solver::HiddenMultiType::Pair,
              ...
              R"(
                ...
                | 2     379   19   | 4     1367  5   | 137    (*69-17)  8        |
                | 4     3579  159  | 8     1367  167 | 137    2         (*69-13) |
                :------------------+-----------------+---------------------------:
    ...
    if (!test(solver::HiddenMultiType::Triple,
              ...
              R"(
                ...
                | 2   9        1        | 8    3        4  | 56  7    56 |
                :-----------------------+------------------+-------------:
                | 45  (*17-5)  (*27-34) | 34   (*12-6)  8  | 9   356  56 |
    ...
    if (!test(solver::HiddenMultiType::Triple,
              ...
              R"(
                ...
                :---------------------+---------------------------+----------------------:
                | 9     3     1568    | 1247   1468   (*256-1478) | 1248   12478   148   |
                | 148   2     18      | 13479  1348   13478       | 6      14789   5     |
                | 7     1456  1568    | 1249   1468   (*256-148)  | 12489  12489   3     |
                :---------------------+---------------------------+----------------------:
                | 1234  1457  12357   | 1234   13468  9           | 13458  14568   1468  |
                | 1234  1459  12359   | 1234   13468  (*26-1348)  | 7      145689  14689 |
    ...
    if (!test(solver::HiddenMultiType::Quadruple,
              ...
              R"(
                ...
                | (*57-29)  (*67-2)  239 | 2348  2489  2349 | (*156)  29   (*15) |
    ...
    if (!test(solver::HiddenMultiType::Quadruple,
              ...
              R"(
                .------------------.---------------.-------------------------.
                | 5679  3     279  | 24   45   27  | 2678  1     (*2459-678) |
                | 567   1256  8    | 234  9    127 | 2367  356   (*245-367)  |
                | 4     125   1279 | 6    135  8   | 237   35    (*259-37)   |
                :------------------+---------------+-------------------------:
                ...
                | 138   148   134  | 7    136  9   | 2368  3568  (*25-368)   |
    ...
    if (!test(solver::HiddenMultiType::Quadruple,
              ...
              R"(
                ...
                :---------+-------------------------+------------:
                | 2  7  9 | 36    (*458-36)  (*458) | 46  35  1  |
                | 1  3  8 | 69    (*245-6)   (*245) | 46  7   59 |
