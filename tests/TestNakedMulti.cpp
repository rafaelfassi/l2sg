...
bool test(solver::NakedMultiType multiType, const std::string &puzzle, const std::string &board, const std::string &expectedBoard)
{
    Grid grid;
    grid.fillBoard(board);

    bool changed = solver::techniques::nakedMulti(grid, multiType);
