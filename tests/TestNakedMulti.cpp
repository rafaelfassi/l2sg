...
int main(int, char **)
{
    ...
    // (7,1) (7,2) (7,7) (7,8)
    if (!test(4, "...36.29.3.......668..2.3549..8..1..7.8.5...9..3..2..553..8..6.8........296.47...",
              R"(
                .-------------------.-----------------.-----------------.
              ...
              R"(
                ...
                :-------------------+-----------------+-----------------:
                | 5   3      147    | 129    8    19  | 479   6     127 |
                | 8   147    147    | 569    39   356 | 59    1247  127 |
                | 2   9      6      | 15     4    7   | 58    138   138 |
                '-------------------'-----------------'-----------------'
              )"))
        return failed();
    ...
    // (5,2)
    // (8,2)
    if (!test(4, "...4...9....58..47...7..3.65...6..1.79.158.32.1..4...91.3..4...98..21....6...5...",
              R"(
                .-------------------.----------------.------------------.
              ...
              R"(
                .----------------.----------------.------------------.
                | 2368  257  157 | 4    13   236  | 1258   9     158 |
                | 236   23   19  | 5    8    2369 | 12     4     7   |
                | 248   45   159 | 7    19   29   | 3      258   6   |
                :----------------+----------------+------------------:
                | 5     234  248 | 239  6    379  | 78     1     48  |
                | 7     9    46  | 1    5    8    | 46     3     2   |
                | 2368  1    268 | 23   4    37   | 578    5678  9   |
    ...
    // ..... (4,1) .....
    // (5,0) ..... 5,2)
    if (!test(4, ".......59.57...6.8...52.743...18..67...7.2..4.7.649..57932145868623..491.4....372",
              R"(
                .--------------------.----------------.-------------.
              ...
              R"(
                ...
                | 169    18    1689 | 5   2    168   | 7    4    3 |
                :-------------------+----------------+-------------:
                | 459    23    459  | 1   8    35    | 29   6    7 |
                | 569    138   569  | 7   35   2     | 189  13   4 |
                | 123    7     18   | 6   4    9     | 128  123  5 |
                :-------------------+----------------+-------------:
                | 7      9     3    | 2   1    4     | 5    8    6 |
                | 8      6     2    | 3   57   57    | 4    9    1 |
